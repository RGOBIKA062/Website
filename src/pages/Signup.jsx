  ...
  return (
    <div className="form-container">
      <div className="form-header">
        <div className="welcome-icon signup">
        ...
        <p className="subtitle">Join our community today and get started</p>
      </div>
      ...
      <p className="redirect">
        Already have an account? <Link to="/" className="login-link">Sign in here</Link>
      </p>
    </div>
  );
}
